...
public class Models {
    ...
    public static class RegistrationHandler {
        ...
        public static void registerModels(final ModelRegistryEvent event) {
            ModelLoader.setCustomModelResourceLocation(Items.FROG_LEG, 0, ResourcesModels.FROG_LEG);
            ...
            //GO-FISHING
            ModelLoader.setCustomModelResourceLocation(Items.FISH, EnumFishType.OAK_FISH.ordinal(), ResourcesModels.OAK_FISH);
            ModelLoader.setCustomModelResourceLocation(Items.FISH, EnumFishType.TERRA_FISH.ordinal(), ResourcesModels.TERRA_FISH);
            ModelLoader.setCustomModelResourceLocation(Items.FISH, EnumFishType.CHARFISH.ordinal(), ResourcesModels.CHARFISH);
            ModelLoader.setCustomModelResourceLocation(Items.FISH, EnumFishType.CARROT_FISH.ordinal(), ResourcesModels.CARROT_FISH);

            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(ModBlocks.WOODEN_CRATE), 0, ResourcesModels.WOODEN_CRATE_ITEM);
            ...
            ModelBakery.registerItemVariants(Items.FISH, ResourcesModels.BLUE_JELLYFISH, ResourcesModels.MAGMA_JELLYFISH, ResourcesModels.MUD_TUNA,
                    ...
                    ResourcesModels.BONE_FISH, ResourcesModels.CURSED_KOI, ResourcesModels.SPOOKYFIN, ResourcesModels.OAK_FISH, ResourcesModels.TERRA_FISH, ResourcesModels.CHARFISH,
                    ResourcesModels.CARROT_FISH);
        }
    }
}
