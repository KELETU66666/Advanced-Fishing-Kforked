...
public class ResourcesModels {
    ...
    public static final ModelResourceLocation FROG_LEG = new ModelResourceLocation(ModInfo.ID + ":frog_leg", "inventory");
    public static final ModelResourceLocation WOODEN_CRATE_ITEM = new ModelResourceLocation(ModInfo.ID + ":wooden_crate", "inventory");
    ...
    public static final ModelResourceLocation OAK_FISH = getFish(EnumFishType.OAK_FISH);
    public static final ModelResourceLocation TERRA_FISH = getFish(EnumFishType.TERRA_FISH);
    public static final ModelResourceLocation CHARFISH = getFish(EnumFishType.CHARFISH);
    public static final ModelResourceLocation CARROT_FISH = getFish(EnumFishType.CARROT_FISH);
    public static final ModelResourceLocation WOODEN_CRATE = getCrate(ModBlocks.WOODEN_CRATE);
    ...
    private static ModelResourceLocation getCrate(Block block) {
        return new ModelResourceLocation(ModInfo.ID + block.getTranslationKey().substring(5), "inventory");
    }
}
